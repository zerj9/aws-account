...
export default class Pipeline extends Construct {
  constructor(scope: Construct, id: string, props: PipelineProps) {
    ...
    const transformLoadLambda = new lambda.Function(this, 'TransformLoadLambdaFunction', {
    ...
    props.s3RawData.grantRead(transformLoadLambda);
    props.s3DataLake.grantReadWrite(transformLoadLambda);
    transformLoadLambda.addToRolePolicy(
